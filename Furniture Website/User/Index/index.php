    ...
    ?>
        ...
        <div class="col col-md-4 pl-5">
          <div class="card" style="width: 20rem;">
            ...
            <img class="card-img-top img-fluid img-responsive rounded product-image" src="img/uploads/<?php echo $row['pimg']; ?>" alt="Card image cap">
            <div class="card-block">
              <h4 class="card-title"><?php echo $row['pname']; ?></h4>
              <p class="card-text">Price: <span>&#8377;</span><?php echo $row['pprice']; ?></p>
